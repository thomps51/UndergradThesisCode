/*!
 * \class KLFitter::LikelihoodTTH_jets
...
#ifndef LIKELIHOODTTH_JETS
#define LIKELIHOODTTH_JETS
...
namespace KLFitter
{
  ...
  class LikelihoodTTH_jets : public KLFitter::LikelihoodBase
  {
